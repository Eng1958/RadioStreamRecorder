...
# ./RadioStreamRecorder/RadioStreamRecorder.py record DLF 5 --recordingtime "20:24" --verbose --album "DLF - Test" --artist "Various" --splittime 15.0
./RadioStreamRecorder/RadioStreamRecorder.py record DLF 1 --verbose --album "DLF - Test" --artist "Various" --splittime 15.0
